...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{secure_asset('startbootstrap-sb-admin-2/vendor/fontawesome-free/css/all.min.css')}}"> 
</head>
<body> 
	<div class=" col-xs-1">
...
<script src="{{secure_asset('startbootstrap-sb-admin-2/vendor/fontawesome-free/js/all.min.js')}}"></script>
</html>